...
function NewPurchaseForm({ addPurchase, handleDoneAdding }) {
    ...
    return (
        <>        <form onSubmit={handleSubmit} className="home-form">
            <input type="text" value={costValue} onChange={(e) => { setCostValue(e.target.value) }} placeholder='Cost' />
            <input type="text" value={itemValue} onChange={(e) => { setItemValue(e.target.value) }} placeholder='Item' />
